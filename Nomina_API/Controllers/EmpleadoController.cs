...
namespace Nomina_API.Controllers
{
    ...
    public class EmpleadoController : ControllerBase
    {
        ...
        private readonly IDeduccionRepository _deduccionRepository;
        ...
        public EmpleadoController(IEmpleadoRepository empleadoRepo, ILogger<EmpleadoController> logger,
            IMapper mapper, I_IngresoRepository ingresoRepository, IDeduccionRepository deduccionRepository, INominaRepository nominaRepository)
        {
