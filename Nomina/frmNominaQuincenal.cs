...
namespace Nomina
{
    public partial class frmNominaQuincenal : Form
    {
        ...
        public void CrearCargarFicheroDatosNominaQuincenal()
        {
            ...
            {
                dgvNominaQ.Rows.Clear(); // Limpia cualquier dato previo en el DataGridView.
                ...
                while (!archivo.EndOfStream)
                {
                    ...
                    if (datos.Length == 19)
                    {
                        ...
                        dgvNominaQ.Rows.Add(NoEmpleado, PNombre, SNombre, PApellido, SApellido, SalarioBase,
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            excel.ExportarAExcel(dgvNominaQ);
        }

        private void BtnExportarNomM_Click(object sender, EventArgs e)
        {
            ExportarExcel excel = new ExportarExcel();
